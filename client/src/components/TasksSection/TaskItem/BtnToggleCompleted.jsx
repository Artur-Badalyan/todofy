...
const BtnToggleCompleted = ({ taskCompleted, taskId, isListInView1 }) => {
    ...
    return (<button title={taskCompleted ? "mark as uncompleted" : "mark as completed"} className={`${taskCompleted
            ? "bg-slate-50 text-slate-600 "
            : "bg-orange-100 text-slate-600 "} ${isListInView1 ? "mr-4" : "mr-4 order-0"} rounded-full font-medium`} onClick={() => toggleTaskCompleted(taskId)}>
